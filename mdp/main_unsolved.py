...
def value_iteration(mdp, gamma, nIt):
    ...
    for it in range(nIt):
        ...
        # TODO: Calculate V based on Vprev, and extract policy pi
        #V = ?
        #pi = ?
        Vs.append(V)
        pis.append(pi)
...
def compute_vpi(pi, mdp, gamma):
    ...
    #TODO: Figure out the linear equation and solve it.
    # a = ?
    # b = ?
...
def policy_iteration(mdp, gamma, nIt):
    ...
    for it in range(nIt):
        ...
        pi = qpi.argmax(axis=1) # Pick the best action based on Q(s,a)
        Vs.append(vpi)
        pis.append(pi)
        pi_prev = pi
    return Vs, pis
